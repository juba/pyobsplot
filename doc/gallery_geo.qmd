...
counties = gpd.read_file("../doc/data/us-counties-10m.json", layer="counties")
counties["id"] = pd.to_numeric(counties["id"])
# Merge unemployment values
unemployment = pd.read_csv("../doc/data/us-county-unemployment.csv")
...
states = gpd.read_file("../doc/data/us-counties-10m.json", layer="states").to_json()
nation = gpd.read_file("../doc/data/us-counties-10m.json", layer="nation").to_json()
