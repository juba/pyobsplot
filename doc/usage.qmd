...
We start by importing the needed classes and create a plot generator object:
...
def generate_plot_spec(opacity):
    return {
      "grid": True,
      "marks": [
            Plot.rectY(penguins, Plot.binX({"y": "count"}, {"x": "body_mass_g", "fill": "royalblue", "fillOpacity": opacity})),
            Plot.ruleY([0])
        ]
    }
...
[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/juba/pyobsplot/blob/main/examples/interactivity.ipynb)
